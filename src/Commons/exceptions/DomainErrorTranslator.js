...
DomainErrorTranslator._directories = {
  ...
  'DETAIL_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat mendapatkan detail comment karena properti yang dibutuhkan tidak ada'),
  'DETAIL_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat mendapatkan detail comment karena tipe data tidak sesuai'),
